...
class CreateBusiness extends PureComponent {
    ...
    onSubmit() {
        ...
        businessService.createBusiness(userEmail, this.state.name, this.state.finalSelected, this.state.address, this.state.state, this.state.city, this.state.postalCode)
            .then(json => {
                console.log(json);
            })
            .catch(reason => {
